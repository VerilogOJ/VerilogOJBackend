...
class SignalName(models.Model):
    ...
    name = models.CharField(max_length=64,help_text='信号名称')
...
class Problem(models.Model):
    ...
    name = models.CharField(max_length=128, help_text='题目名称')
    ...
    # [题目属性-手动添加]
    # 必有
    top_module = models.CharField(max_length=64, help_text='顶层模块名字') # 必有 否则无法判题
    ...
    tags = models.CharField(max_length=128, help_text="题目标签", blank=True)
