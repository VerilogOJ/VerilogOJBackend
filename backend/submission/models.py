...
class LibraryMapping(models.Model):
    ...
    error = models.TextField(help_text="元件库错误",blank=True)
...
class SubmissionResult(models.Model):
    ...
    yosys_cmos_result = models.ManyToManyField(LibraryMapping,help_text='yosys_cmos元件库生成电路图和资源报告',blank=True)
    google_130nm_result = models.ManyToManyField(LibraryMapping,help_text='google_130nm元件库生成电路图和资源报告',blank=True)
    xilinx_fpga_result = models.ManyToManyField(LibraryMapping,help_text='xilinx_fpga元件库生成电路图和资源报告',blank=True)
    class Meta:
